...
def getDeviceCommands(){
    ...
    command_input = [
        ...
        pandora: [command: "PANDORA", name: "Pandora",         val: false, delay: 1],
        seriusxm: [command: "SIRIUSXM", name: "SeriusXM",      val: false, delay: 1],
        iradio:  [command: "IRADIO",  name: "Pandora",         val: false, delay: 1],
        server:  [command: "SERVER",  name: "Server",          val: false, delay: 1],
        favorites: [command: "FAVORITES", name: "Favorites",   val: false, delay: 1],
        bluetooth: [command: "BT",    name: "Bluetooth",       val: false, delay: 1],
        usb:     [command: "USB/IPOD", name: "USB/iPod",       val: false, delay: 1],
    ...
    video_select = [
        off:     [command: "OFF",     name: "Off",             val: false, delay: 1],
        on:      [command: "ON",      name: "On",              val: false, delay: 1],
        dvd:     [command: "DVD",     name: "DVD",             val: false, delay: 1], 
        blueray: [command: "BD",      name: "BlueRay",         val: false, delay: 1],
        tv:      [command: "TV",      name: "TV",              val: false, delay: 1],
        sat_cbl: [command: "SAT/CBL", name: "Satellite/Cable", val: false, delay: 1],
        mplay:   [command: "MPLAY",   name: "Media Player",    val: false, delay: 1],
        game:    [command: "GAME",    name: "Game",            val: false, delay: 1],
        aux:     [command: "AUX1",    name: "Auxiliary",       val: false, delay: 1],
        network: [command: "NET",     name: "Network",         val: false, delay: 1],
